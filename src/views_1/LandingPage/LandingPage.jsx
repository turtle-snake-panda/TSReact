...
import Parallax from "components_1/Parallax/Parallax.jsx";
    ...
    return (
      <div>
        <Header
          ...
          {...rest}
        />
        <Parallax filter image={require("assets/img/world-map.png")}>
          
          <div className={classes.container}>          
            <GridContainer>
              <GridItem xs={12} sm={12} md={6}>
                <h1 className={classes.title}>Our Story Starts.</h1>
                <h4>
                  Please visit here. It will maybe your glad to visit.
                </h4>
                <br />
                <Button
                  color="danger"
