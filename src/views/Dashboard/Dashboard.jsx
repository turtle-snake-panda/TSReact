              ...
              tabs={[
                {
                  ...
                  tabContent: (
                    <Tasks
                      ...
                      modalItem={["IMEI","DeviceOwner","Address1"]}
                      modalTitle="Device"
                    />
                  )
                }
              ...
              tabs={[                
                {
                  ...
                  tabContent: (
                    <Tasks
                      ...
                      tasksIndexes={[0, 1,2,3]}
                      tasks={call_nums}
                      taskHead={["ID", "Cell Number","Name","Address", "SMS OUT", "SMS IN","Action"]}
                      modalItem={["CellNumber","CellPhoneOwner","Address2"]}
